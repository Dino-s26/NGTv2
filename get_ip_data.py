...
filename = 'C:/Users/alldi/Documents/GitHub/NGTv2/testing_get_ip_data.xlsx'
...
def create_log():
    ...
    log_name = "script_log-VM_Capture-"+get_date()[0]+".log" ''' change [Device] to appropriate device use '''
